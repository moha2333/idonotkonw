...
pk.dump(train_y, open('../data/model_fea_add3_train_y.pkl', 'wb'), protocol=4)
...
sparse.save_npz('../data/model_fea_add3_train.npz', train_x)
sparse.save_npz('../data/model_fea_add3_test.npz', test_x)
...
def LGB_predict(train_x, train_y, test_x, res):
    ...
    res.to_csv('../data/submission_model_fea_add3.csv', index=False)
    return clf


model = LGB_predict(train_x,train_y,test_x,res)
joblib.dump(model, '../data/model_fea_add3.model')
